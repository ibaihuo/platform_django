...
CAPTCHA_FONT_SIZE = getattr(settings,'CAPTCHA_FONT_SIZE', 28)
...
CAPTCHA_CHALLENGE_FUNCT = getattr(settings,'CAPTCHA_CHALLENGE_FUNCT','captcha.helpers.math_challenge')
