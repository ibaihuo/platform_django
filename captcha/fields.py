...
class CaptchaTextInput(MultiWidget):
    ...
    def render(self, name, value, attrs=None):
        ...
        try:
            ...
            raise ImproperlyConfigured('Make sure you\'ve included captcha.urls ')        
...
class CaptchaField(MultiValueField):
    ...
    def __init__(self, *args,**kwargs):
        ...
        if 'error_messages' not in kwargs or 'invalid' not in kwargs.get('error_messages'):
            ...
            kwargs['error_messages'].update(dict(invalid='验证码不对!'))
    ...
    def clean(self, value):
        ...
        try:
            ...
            raise ValidationError(getattr(self,'error_messages',dict()).get('invalid', '验证码不对!'))
        return value
